class TaskFlow {
  constructor() {
    ...
    // ... rest of filter and category initialization stays the same

    this.initializeApp();
    this.bindEvents();

    // Load tasks asynchronously after setup
    this.initializeData();
  }

  // Add this new method after the constructor (around line 26):
  ...
  getFilteredTasks() {
    return this.tasks.filter((task) => this.matchesSearch(task) && this.matchesFilter(task));
  }
